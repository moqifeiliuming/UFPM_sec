...
python tools/convert_datasets/cityscapes.py ./datas/cityscapes --nproc 8 --out-dir ./datas/cityscapes/annotations
```
...
# We also need to change the num_classes in head from 80 to 8, to match the cityscapes datas's annotation.
