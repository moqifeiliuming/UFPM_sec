...
# data_root = 'data/coco/'
data_root = 'dataset/UAVDT'        # 数据集根目录
test_pipeline = [
    dict(type='LoadImageFromFile'),
    dict(
...
data = dict(
    ...
    train=dict(
        ...
        dataset=dict(
            type=dataset_type,
            ann_file=data_root + 'annotations/UAV-benchmark-M-Train.json',
...
runner = dict(type='EpochBasedRunner', max_epochs=73)  # 相当于6x（72轮）
