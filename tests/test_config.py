...
def test_config_data_pipeline(config_rpath):
    """Test whether the datas pipeline is valid and can process corner cases.
    ...
    print(f'Building datas pipeline, config_fpath = {config_fpath}')

    print(f'Test training datas pipeline: \n{train_pipeline!r}')
    ...
    print(f'Test testing datas pipeline: \n{test_pipeline!r}')
    results = dict(
        filename='test_img.png',
        ori_filename='test_img.png',
        img=img,
    ...
    # test empty GT
    print('Test empty GT with training datas pipeline: '
          f'\n{train_pipeline!r}')
    results = dict(
        filename='test_img.png',
        ori_filename='test_img.png',
    ...
    print(f'Test empty GT with testing datas pipeline: \n{test_pipeline!r}')
    results = dict(
        filename='test_img.png',
        ori_filename='test_img.png',
        img=img,
