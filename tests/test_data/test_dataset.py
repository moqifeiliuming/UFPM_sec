...
def test_dataset_evaluation():
    ...
    # test single coco datas evaluation
    ...
    # test concat datas evaluation
    fake_concat_results = _create_dummy_results() + _create_dummy_results()

    # build concat datas through two config dict
    coco_cfg = dict(
        type='CocoDataset',
    ...
    # build concat datas through concatenated ann_file
    coco_cfg = dict(
        type='CocoDataset',
    ...
    # test single custom datas evaluation
    ...
    # build concat datas through explict type
    concat_cfg = dict(
        type='ConcatDataset',
...
def test_allow_empty_images(classes, expected_length):
    ...
    filtered_dataset = dataset_class(
        ann_file='tests/datas/coco_sample.json',
        img_prefix='tests/datas',
        pipeline=[],
        classes=classes,
